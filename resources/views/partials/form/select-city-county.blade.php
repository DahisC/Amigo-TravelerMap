<div v-pre id="city-county-selector" class="col-12 mb-3">
  ...
  <div class="row">
    ...
    <div class="col-6">
      ...
      <select id="select_city" name="region" class="form-select"
              v-on:change="selectedCityName = $event.target.value; selectedAreaName = '';"
              onchange="select_area.value = ''">
        ...
        @else
          <option selected value="">選擇</option>
        @endif
        <template v-for="city of cityCounty">

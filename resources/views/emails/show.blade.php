...
<body style="word-spacing:normal;background-color:#d6dde5;">
    <div style="background-color:#d6dde5;">
        <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
            <table align="center" class="border-bottom" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td align="justify"
                                                ...
                                                <div
                                                    ...
                                                    <p class="mb-3">
                                                        <b>阿米狗是每個人的旅人地圖，記錄著那些短暫出現卻又精彩萬分的事物</b></p>
                                                    <p class="mb-3" font-weight: bold;"color: rgb(57, 63, 76);">
                                                        源自於西班牙文中「朋友」的 Amigo 一詞，我們就像那位最凱瑞你的朋友！</p>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" id="table"
                ...
                table-layout:fixed">
                    ...
                    <tr style="border:3px;">
                        ...
                        <td class="attraction">
                            {{ $attraction->parking_info }}
                        </td>
                        <td class="attraction">
                            {{ $attraction->position->address }}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
